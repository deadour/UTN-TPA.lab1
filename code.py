...
# Función para hacer sonar la bocina
...
try:
    ...
    while True:
        ...
        if is_value_valid(sensor_value):    # Verifica que es válido
            if (lastValue - 1000) > sensor_value:     # Pregunta si el valor medido es menor que el anterior
